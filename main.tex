...
\graphicspath{{figures/}} % Directory in which figures are stored
 ...
 \definecolor{bordercol}{RGB}{249, 253, 11} % Border color of content boxes
...
\vspace{0.2cm} 
\footnotesize \underline{André Rossi Korol}$^1$, Francisco Carlos Rocha Fernandes$^1$\\  % Author names
\footnotesize $^1$\it {UNIVAP - Universidade do Vale do Paraíba}\\ % Institution names
